...
final class MinecraftGlStateBridge implements RhiGlStateBridge {
    static final MinecraftGlStateBridge INSTANCE = new MinecraftGlStateBridge();

    private MinecraftGlStateBridge() {
    }
